<div class="bg-charcoal-black w-full text-whitish-gray">
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 p-4">
    ...
    <div class="p-6">
      <div class="font-bold text-xl text-white">Hot Links</div>
      <ul>
    ...
    <div class="p-6">
      <div class="font-bold text-xl text-white">Useful Links</div>
      <ul>
        <li class="mt-2 hover:cursor-pointer hover:text-tourism-green">
    ...
    <div class="p-6">
      <div class="font-bold text-xl text-white">Others</div>
      <ul>
    ...
    <div class="p-6">
      <div class="font-bold text-xl text-white">Follow Us</div>
      ...
      <div class="font-bold text-xl mt-6">Download App</div>
  ...
  <div class="bg-footer-line h-px"></div>
  <div class="grid md:grid-cols-2 sm:grid-cols-1 p-4">
    <div class="flex-col mt-auto mb-auto p-6">
